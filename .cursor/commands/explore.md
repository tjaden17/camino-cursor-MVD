...
- Determine exactly how this issue/idea/concept/feature integrates, including dependencies, structure, edge cases (within reason, don't go overboard), and constraints.
...
This command will be available in chat with /explore
