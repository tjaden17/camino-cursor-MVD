...
| Document | Role |
|----------|------|
| [`../README.md`](../README.md) | **Planning hub** — implementation plans vs product backlog, sync rules. |
| [`../backlog/PRODUCT_BACKLOG.md`](../backlog/PRODUCT_BACKLOG.md) | Product backlog and shipped history. |
...
| [`../../docs/architecture/MVD_ARCHITECTURE_AND_DATA_FLOW.md`](../../docs/architecture/MVD_ARCHITECTURE_AND_DATA_FLOW.md) | Data flow and artifacts. |
...
- [ ] Phase A complete (repo hardening: see [`IMPLEMENTATION_PLAN_PATH_TO_PROD_PHASE_A.md`](IMPLEMENTATION_PLAN_PATH_TO_PROD_PHASE_A.md) — branch protection remains manual in GitHub)
- [ ] Phase B complete
- [ ] Phase C complete
